...
Nova.booting(function (Vue, router) {
    ...
    var registeredViews = JSON.parse('{"index":{"route":"index","component":"Index","name":"f-arms-index-view"}}');
    Object.keys(registeredViews).forEach(function (key) {
        Vue.component(registeredViews[key]['name'], __webpack_require__(5)("./" + registeredViews[key]['component']));
    });
    Vue.component('custom-create-resource-button', __webpack_require__(11));
});
